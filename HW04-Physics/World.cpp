...
World::World(const std::string& worldFilePath) {
    ...
    while (stream.peek(), stream.good()) {
        ...
        // radius = 10;
        // color = {255,0,0};
        // Dust dust(center, velocity, radius, color, true);
        // dusts.push_back(dust);
        // center = {200,200};
        // radius = 10;
        // color = {0,255,0};
        // Dust dust1(center, velocity, radius * 2, color, true);
        // dusts.push_back(dust1);
        // center = {100,100};
        // radius = 10;
        // color = {0,0,255};
        // Dust dust(center, velocity, radius * 3, color, true);
...
void World::update(double time) {
    ...
    physics.update(dusts, balls, ticks);
}
